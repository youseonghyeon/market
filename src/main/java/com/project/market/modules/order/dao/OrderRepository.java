...
public interface OrderRepository extends JpaRepository<Orders, Long> {
    ...
    List<Orders> findByCustomerAndOrderStatusIsOrderByOrderDateTimeDesc(Account account, OrderStatus orderStatus);

    @EntityGraph(value = "withItemAndDelivery", type = EntityGraph.EntityGraphType.FETCH)
    List<Orders> findByCustomerOrderByOrderDateTimeDesc(Account account);
}
